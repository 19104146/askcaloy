...
export function Message({ content, isUserMessage }: MessageProps) {
    return (
        <div
            className={cn({
                    ...
                    <div className="ml-6 flex w-full flex-col">
                        <div className="flex items-center space-x-2">
                            <span className="text-sm font-semibold text-gray-900 dark:text-white">
                                {isUserMessage ? "You" : "Caloy"}
                            </span>
                        </div>

                        <p className="py-2.5 text-sm font-normal text-gray-900 dark:text-white">{content}</p>
                    </div>
                </div>
            </div>
        </div>
